...
const LAYOUTS: LayoutMeta[] = [
  ...
  { id: "bold-header",       industry: ["finance", "consulting", "real-estate"], density: "balanced", font: "sans", textAlign: "left", safeLogoPositions: ["bottom-right", "bottom-left"] },
  ...
  { id: "bottom-heavy",      industry: ["creative-agency", "photography", "consulting"], density: "airy", font: "sans", textAlign: "left", safeLogoPositions: ["top-right", "top-center"] },
  ...
  { id: "compact-modern",    industry: ["healthcare", "consulting", "finance"], density: "compact", font: "sans", textAlign: "left", safeLogoPositions: ["top-right", "bottom-right"] },
  ...
  { id: "bottom-bar",        industry: ["finance", "consulting", "legal"], density: "balanced", font: "sans", textAlign: "left", safeLogoPositions: ["top-right"] },
  { id: "sandwich-bands",    industry: ["education", "healthcare", "nonprofit"], density: "balanced", font: "sans", textAlign: "center", safeLogoPositions: ["top-left", "top-right", "bottom-left", "bottom-right"] },
  ...
  { id: "circle-motif",      industry: ["beauty-wellness", "photography", "creative-agency"], density: "airy", font: "sans", textAlign: "left", safeLogoPositions: ["top-left", "top-right", "bottom-left"] },
  { id: "badge-emblem",      industry: ["legal", "finance", "consulting"], density: "balanced", font: "serif", textAlign: "center", safeLogoPositions: ["bottom-left", "bottom-right"] },
  ...
  { id: "card-inset",        industry: ["beauty-wellness", "real-estate", "consulting"], density: "balanced", font: "sans", textAlign: "left", safeLogoPositions: ["top-right", "bottom-right"] },
  ...
  { id: "stepped-blocks",    industry: ["construction", "tech", "consulting"], density: "balanced", font: "sans", textAlign: "left", safeLogoPositions: ["top-right", "bottom-right"] },
  { id: "neon-dark",         industry: ["entertainment", "tech", "food-dining"], density: "balanced", font: "sans", textAlign: "left", safeLogoPositions: ["top-right", "bottom-right"] },
  { id: "full-bleed",        industry: ["retail", "food-dining", "entertainment"], density: "balanced", font: "sans", textAlign: "left", safeLogoPositions: ["top-right", "bottom-right"] },
  { id: "ribbon-banner",     industry: ["food-dining", "entertainment", "nonprofit"], density: "balanced", font: "serif", textAlign: "center", safeLogoPositions: ["top-right", "bottom-right"] },
  ...
  { id: "dot-grid",          industry: ["finance", "tech", "consulting"], density: "compact", font: "sans", textAlign: "left", safeLogoPositions: ["top-right", "top-left", "bottom-center"] },
  { id: "overlap-cards",     industry: ["creative-agency", "retail", "photography"], density: "balanced", font: "sans", textAlign: "left", safeLogoPositions: ["top-right", "bottom-right"] },
